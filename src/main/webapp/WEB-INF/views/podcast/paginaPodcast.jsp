				          ...
				          <c:forEach items="${episodios}" var="episodio">
				            ...
				            <div class="col-md-4">
				              <div class="card mb-4 shadow-sm">
				                <img class="card-img-top" src="/bordeau/${episodio.capa}" alt="Thumbnail [100%x225]" style="height: 225px; width: 100%; display: block;">
				                <div class="card-body">
				                  <a href="${s:mvcUrl('EC#exibirPagina').arg(0,episodio.id).build()}" class="text-dark"><h4 class="text-dark">${episodio.titulo}</h4></a>
				                  <p class="card-text">${novoEpisodio.descricao}</p>
				                  <div class="d-flex justify-content-between align-items-center">
				                    <div class="btn-group">
				                      <a href="${s:mvcUrl('PC#exibirPagina').arg(0,podcast.id).build()}" class="text-dark"><button type="button" class="btn btn-sm btn-outline-secondary">conheça o podcast</button></a>
				                    </div>
